...
assert Krava_accuracy_score(actual, predicted_RF) == accuracy_score(actual, predicted_RF), \
    'my accuracy_score failed RF'

assert Krava_accuracy_score(actual, predicted_LR) == accuracy_score(actual, predicted_LR), \
...
assert Krava_recal_score(actual, predicted_RF) == recall_score(actual, predicted_RF),\
    'my recal_score fails on RF'

assert Krava_recal_score(actual, predicted_LR) == recall_score(actual, predicted_LR),\
...
assert Krava_precision_score(actual, predicted_RF) == precision_score(actual, predicted_RF),\
    'my precision_score fails on RF'

assert Krava_precision_score(actual, predicted_LR) == precision_score(actual, predicted_LR),\
